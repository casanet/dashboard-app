...
const SWAGGER_GEN_REQUEST_BODY = {
	...
	specURL: `https://raw.githubusercontent.com/casanet/casanet-server/${ENV_BRANCH}/backend/swagger.json`,
	type: 'CLIENT',
	codegenVersion: 'V3',
	options: {
		supportsES6: true,
...
const CRED_MGR_IMPORT_STATEMENT = "import { credentialsManager } from '../../credential-manager';\n";
